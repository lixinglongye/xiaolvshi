...
export type LegalRagEmbeddingReadinessGateRow = {
  id: string;
  task: string;
  route_mode: string;
  input_scope: string[];
  ...
  cost_tier: string;
  route_status: string;
  index_coverage_status: string;
  retrieval_diagnostics_status: string;
...
export type LegalRagEmbeddingReadinessGate = {
  id: 'legal-rag-embedding-readiness-gate' | string;
  title?: string;
  status: string;
  summary: {
    ...
    multimodal_review_required_count: number;
    index_plan_row_count: number;
    index_ready_plan_count: number;
    index_review_plan_count: number;
    index_blocked_plan_count: number;
    diagnostic_row_count: number;
    diagnostic_review_row_count: number;
    diagnostic_blocked_row_count: number;
    model_called: boolean;
    gateway_called: boolean;
    newapi_called: boolean;
    network_called: boolean;
    ...
    raw_retrieved_context_included: boolean;
    raw_legal_text_included: boolean;
    raw_embedding_vectors_included: boolean;
    source_ids_returned: boolean;
    credentials_included: boolean;
    [key: string]: unknown;
  };
  readiness_rows: LegalRagEmbeddingReadinessGateRow[];
  ...
  linked_gate_summary: {
    ...
    embedding_preflight_warning_check_ids?: string[];
    index_release_action_counts?: Record<string, number>;
    retrieval_release_action_counts?: Record<string, number>;
    [key: string]: unknown;
  };
  readiness_policy: {
    method: string;
    cheap_first_text_embedding_default: string;
    text_embedding_routes_can_preflight_without_review: boolean;
    multimodal_embedding_requires_operator_review: boolean;
    blocks_on_empty_index_coverage: boolean;
    blocks_on_missing_retrieval_locator: boolean;
    blocks_on_forbidden_query_filters: boolean;
    requires_retrieval_diagnostics_before_answer_claims: boolean;
...
export type LegalRagEmbeddingBatchApprovalPacketItem = {
  ...
  privacy_boundary: {
    ...
    source_chunks_returned: boolean;
    embedding_vectors_returned: boolean;
    approver_identity_returned: boolean;
    model_called: boolean;
    gateway_called: boolean;
    network_called: boolean;
    approval_record_written: boolean;
...
export type LegalRagEmbeddingBatchApprovalPacket = {
  id: 'legal-rag-embedding-batch-approval-packet' | string;
  title?: string;
  schema_version: string;
  status: string;
  summary: {
    ...
    embedding_default_model: string;
    embedding_default_canonical_model: string;
    batch_budget_gate_status: string;
    approval_record_written: boolean;
    model_called: boolean;
    gateway_called: boolean;
    newapi_called: boolean;
  ...
  approval_items: LegalRagEmbeddingBatchApprovalPacketItem[];
  approval_status_counts: Record<string, number>;
  run_action_counts: Record<string, number>;
  ready_item_ids: string[];
  hold_item_ids: string[];
  blocked_item_ids: string[];
  linked_gate_summary: {
    legal_rag_embedding_batch_budget_gate?: string;
    legal_rag_embedding_index_dry_run_gate?: string;
    legal_rag_embedding_chunk_policy_gate?: string;
    modelops_gemini_embedding_cheap_first_preflight?: string;
    embedding_default_model?: string;
  ...
  input_contract: {
    accepted_source_fields: string[];
    accepted_approval_fields: string[];
    forbidden_fields_ignored: string[];
    source_id_echoed: boolean;
    approval_identity_collected: boolean;
    approval_record_written: boolean;
    approval_packet_only: boolean;
    [key: string]: unknown;
  };
  approval_policy: {
    method: string;
    max_parallel_embedding_requests: number;
    requires_ready_batch_budget_rows: boolean;
    requires_maintainer_signoff_for_ready_rows: boolean;
    requires_rag_index_reviewer_for_ready_rows: boolean;
    holds_review_required_budget_rows: boolean;
    blocks_blocked_budget_rows: boolean;
    approval_record_written: boolean;
    embedding_run_allowed: boolean;
    model_call_allowed: boolean;
    index_write_allowed: boolean;
  ...
  privacy_boundary: {
    ...
    returns_credentials: boolean;
    returns_gateway_payloads: boolean;
    returns_approver_identity: boolean;
    calls_newapi: boolean;
    calls_gemini: boolean;
    calls_gateway: boolean;
    calls_model: boolean;
    ...
    writes_index: boolean;
    writes_database: boolean;
    writes_approval_record: boolean;
    downloads_datasets: boolean;
    network_called: boolean;
    [key: string]: unknown;
  };
...
export type LegalRagEmbeddingBatchObservationGateRow = {
  id: string;
  source_type: string;
  queue_order: number;
  approval_status: string;
  approval_run_action: string;
  observed_status: string;
  observation_status: string;
  release_action: string;
  expected_batch_count: number;
  observed_batch_count: number;
  batch_count_delta: number;
  ...
  privacy_boundary: {
    source_ids_returned: boolean;
    source_approval_item_ids_returned: boolean;
    raw_legal_text_returned: boolean;
    source_chunks_returned: boolean;
    embedding_vectors_returned: boolean;
    approver_identity_returned: boolean;
...
export type LegalRagEmbeddingBatchObservationGate = {
  ...
  summary: {
    ...
    ready_for_index_review_count: number;
    review_row_count: number;
    blocked_row_count: number;
    pending_observation_count: number;
    observed_batch_total: number;
    expected_batch_total: number;
    observed_chunk_total: number;
    expected_chunk_total: number;
    observed_vector_slot_total: number;
    expected_vector_slot_total: number;
    observed_token_total: number;
    expected_token_total: number;
    observed_cost_usd: number;
    expected_cost_usd: number;
    max_cost_delta_usd: number;
    max_parallel_embedding_requests: number;
    embedding_default_model: string;
    embedding_default_canonical_model: string;
    ...
    newapi_called: boolean;
    network_called: boolean;
    embeddings_created_by_gate: boolean;
    index_written: boolean;
    database_written: boolean;
    source_ids_returned: boolean;
    source_approval_item_ids_returned: boolean;
  ...
  observation_rows: LegalRagEmbeddingBatchObservationGateRow[];
  observation_status_counts: Record<string, number>;
  release_action_counts: Record<string, number>;
  ready_row_ids: string[];
  ...
  input_contract: {
    ...
    forbidden_fields_ignored: string[];
    source_id_echoed: boolean;
    source_approval_item_id_echoed: boolean;
    approval_identity_collected: boolean;
    approval_record_written: boolean;
    aggregate_observations_only: boolean;
    [key: string]: unknown;
  };
  observation_policy: {
    method: string;
    requires_external_approval_before_run: boolean;
    requires_external_batch_observation: boolean;
    requires_vector_slot_match: boolean;
    requires_cost_within_review_multiplier: number;
    requires_token_within_review_multiplier: number;
    max_parallel_embedding_requests: number;
    embedding_creation_allowed: boolean;
    model_call_allowed: boolean;
    index_write_allowed: boolean;
  ...
  claim_boundary: {
    maintainer_approval_claimed: boolean;
    embedding_batch_executed_claimed_by_gate: boolean;
    legal_advice_claimed: boolean;
    retrieval_quality_claimed: boolean;
    embedding_quality_claimed: boolean;
    index_quality_claimed: boolean;
  ...
  privacy_boundary: {
    metadata_only: boolean;
    returns_source_ids: boolean;
    returns_source_approval_item_ids: boolean;
    returns_raw_query: boolean;
    returns_user_question: boolean;
    returns_retrieved_context: boolean;
    returns_raw_legal_text: boolean;
...
export type LegalDocumentBenchmarkRoutePlanExecutionResultHandoffRow = {
  id: string;
  case_id: string;
  phase: string;
  handoff_status: string;
  can_attach_to_release: boolean;
  handoff_action: string;
  archive_release_action: string;
  route_plan_match: boolean;
  cheap_first_aligned: boolean;
  observed_status: string;
  observed_model: string;
...
export type LegalDocumentBenchmarkRoutePlanExecutionResultHandoffCheck = {
  id: string;
  status: string;
  reason: string;
  evidence_count: number;
...
export type LegalDocumentBenchmarkRoutePlanExecutionResultHandoff = {
  id: string;
  title: string;
  status: string;
  method: {
  ...
  summary: {
    ...
    max_parallel_model_requests: number;
    forbidden_payload_field_count: number;
    ready_for_release_evidence: boolean;
    release_action: string;
    raw_payload_echoed: boolean;
    model_called: boolean;
    gateway_called: boolean;
    network_called: boolean;
    archive_file_written: boolean;
    maintainer_approval_recorded: boolean;
    benchmark_execution_claimed: boolean;
    traffic_shifted: boolean;
    configuration_written: boolean;
  };
  handoff_rows: LegalDocumentBenchmarkRoutePlanExecutionResultHandoffRow[];
  checks: LegalDocumentBenchmarkRoutePlanExecutionResultHandoffCheck[];
  blocking_check_ids: string[];
  warning_check_ids: string[];
  source_summaries: {
    execution_readiness: Record<string, unknown>;
  ...
  release_evidence_packet: {
    ...
    requires_ready_readiness_packet: boolean;
    requires_ready_result_archive: boolean;
    requires_fixture_limit: boolean;
    requires_max_parallel_model_requests: number;
    records_maintainer_approval: boolean;
    writes_release_record: boolean;
    executes_benchmark: boolean;
    allowed_evidence_summary: string;
  };
  privacy_boundary: Record<string, unknown>;
  claim_boundary: Record<string, unknown>;
  recommended_actions: string[];
...
type LegalRagEmbeddingBatchApprovalPacketResponse = {
  success: boolean;
  data: LegalRagEmbeddingBatchApprovalPacket;
};
...
export async function getLegalDocumentBenchmarkRoutePlanExecutionResultHandoff(): Promise<LegalDocumentBenchmarkRoutePlanExecutionResultHandoff> {
  const resp = await client.apiCall.invoke({
    url: '/api/v1/maintenance/legal-review-benchmark/document-route-plan/execution-result-handoff',
    method: 'GET',
  });
  const payload = (resp?.data ?? resp) as
    | LegalDocumentBenchmarkRoutePlanExecutionResultHandoffResponse
    | LegalDocumentBenchmarkRoutePlanExecutionResultHandoff;
  if ('success' in payload && 'data' in payload) {
    return payload.data;
  }
  return payload as LegalDocumentBenchmarkRoutePlanExecutionResultHandoff;
}

export async function evaluateLegalDocumentBenchmarkRoutePlanExecutionResultHandoff(
  payload: Record<string, unknown> = {},
): Promise<LegalDocumentBenchmarkRoutePlanExecutionResultHandoff> {
  const resp = await client.apiCall.invoke({
    url: '/api/v1/maintenance/legal-review-benchmark/document-route-plan/execution-result-handoff',
    method: 'POST',
    data: payload,
...
export async function getLegalRagEmbeddingReadinessGate(): Promise<LegalRagEmbeddingReadinessGate> {
  const resp = await client.apiCall.invoke({
    url: '/api/v1/maintenance/legal-rag-embedding-readiness-gate',
    method: 'GET',
  });
...
export async function getLegalRagEmbeddingBatchApprovalPacket(): Promise<LegalRagEmbeddingBatchApprovalPacket> {
  const resp = await client.apiCall.invoke({
    url: '/api/v1/maintenance/legal-rag-embedding-batch-approval-packet',
    method: 'GET',
  });
  return unwrapMaintenanceData<LegalRagEmbeddingBatchApprovalPacketResponse['data']>(resp);
}

export async function getLegalRagEmbeddingBatchObservationGate(): Promise<LegalRagEmbeddingBatchObservationGate> {
  const resp = await client.apiCall.invoke({
    url: '/api/v1/maintenance/legal-rag-embedding-batch-observation-gate',
    method: 'GET',
  });
  return unwrapMaintenanceData<LegalRagEmbeddingBatchObservationGateResponse['data']>(resp);
}

export async function evaluateLegalRagEmbeddingBatchObservationGate(
  payload: Record<string, unknown>,
): Promise<LegalRagEmbeddingBatchObservationGate> {
  const resp = await client.apiCall.invoke({
    url: '/api/v1/maintenance/legal-rag-embedding-batch-observation-gate',
    method: 'POST',
    data: payload,
