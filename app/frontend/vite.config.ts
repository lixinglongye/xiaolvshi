...
process.env.VITE_APP_TITLE ??= process.env.OVERVIEW_TITLE ?? 'LawAudit Radar';
process.env.VITE_APP_DESCRIPTION ??= process.env.OVERVIEW_DESCRIPTION ?? 'Legal document review and generation platform';
