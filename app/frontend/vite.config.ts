...
process.env.VITE_APP_TITLE ??= process.env.OVERVIEW_TITLE ?? '律审雷达 · LawAudit Radar';
process.env.VITE_APP_DESCRIPTION ??= process.env.OVERVIEW_DESCRIPTION ?? '法律文书智能审查与生成平台';
