...
const checks = [
  ...
  () => assertIncludes(maintenanceApi, 'LegalDocumentBenchmarkRoutePlan', 'legal document benchmark route plan type'),
  () => assertIncludes(maintenanceApi, 'LegalDocumentBenchmarkRoutePlanCaseRow', 'legal document benchmark route plan case row type'),
  () => assertIncludes(maintenanceApi, 'LegalDocumentBenchmarkRoutePlanRoute', 'legal document benchmark route plan route type'),
  ...
  () => assertIncludes(maintenanceApi, 'LegalDocumentBenchmarkRoutePlanExecutionReviewPacket', 'legal document benchmark route plan execution review packet type'),
  () => assertIncludes(maintenanceApi, 'LegalDocumentBenchmarkRoutePlanExecutionReviewItem', 'legal document benchmark route plan execution review item type'),
  () => assertIncludes(maintenanceApi, 'LegalDocumentBenchmarkRoutePlanExecutionReviewPacketCheck', 'legal document benchmark route plan execution review packet check type'),
  ...
  () => assertIncludes(maintenancePage, 'Legal document benchmark cheap-first route plan', 'legal document benchmark route plan panel'),
  () => assertIncludes(maintenancePage, 'previewLegalDocumentRoutePlanOverride', 'legal document route plan override preview handler'),
  () => assertIncludes(maintenancePage, 'routePlanOverrideCaseId', 'legal document route plan override case state'),
  () => assertIncludes(maintenancePage, 'routePlanOverrideTask', 'legal document route plan override task state'),
  () => assertIncludes(maintenancePage, 'routePlanOverrideModel', 'legal document route plan override model state'),
  () => assertIncludes(maintenancePage, 'routePlanOverrideApproval', 'legal document route plan override approval state'),
  () => assertIncludes(maintenancePage, 'routePlanOverrideLoading', 'legal document route plan override loading state'),
  () => assertIncludes(maintenancePage, 'hasForbiddenRoutePlanOverrideModel', 'legal document route plan override credential guard'),
  () => assertIncludes(maintenancePage, 'evaluateLegalDocumentBenchmarkRoutePlan', 'legal document route plan override POST binding'),
  () => assertIncludes(maintenancePage, 'Override preview', 'legal document route plan override panel'),
  () => assertIncludes(maintenancePage, 'Preview override', 'legal document route plan override button'),
  () => assertIncludes(maintenancePage, 'Simulate approval', 'legal document route plan override approval mode'),
  () => assertIncludes(maintenancePage, 'cheap_precheck_case_count', 'legal document route plan precheck metric'),
  () => assertIncludes(maintenancePage, 'premium_primary_case_count', 'legal document route plan premium metric'),
  () => assertIncludes(maintenancePage, 'routed_to_recommended_count', 'legal document route plan recommended-route metric'),
  () => assertIncludes(maintenancePage, 'estimated_precheck_cost_usd', 'legal document route plan precheck cost metric'),
  () => assertIncludes(maintenancePage, 'estimated_primary_cost_usd', 'legal document route plan primary cost metric'),
  () => assertIncludes(maintenancePage, 'case_route_rows', 'legal document route plan case row binding'),
  () => assertIncludes(maintenancePage, 'precheck_route', 'legal document route plan precheck route binding'),
  () => assertIncludes(maintenancePage, 'primary_route', 'legal document route plan primary route binding'),
  () => assertIncludes(maintenancePage, 'route_policy', 'legal document route plan policy binding'),
  ...
  () => assertIncludes(maintenancePage, 'getLegalDocumentBenchmarkRoutePlanExecutionReviewPacket', 'legal document route plan execution review packet load task'),
  () => assertIncludes(maintenancePage, 'legalDocumentBenchmarkRoutePlanExecutionReviewPacket', 'legal document route plan execution review packet state binding'),
  () => assertIncludes(maintenancePage, 'runLegalDocumentRoutePlanExecutionReviewPacket', 'legal document route plan execution review packet handler'),
  () => assertIncludes(maintenancePage, 'routePlanExecutionReviewPacketLoading', 'legal document route plan execution review packet loading state'),
  () => assertIncludes(maintenancePage, 'routePlanExecutionReviewPacketError', 'legal document route plan execution review packet error state'),
  () => assertIncludes(maintenancePage, 'evaluateLegalDocumentBenchmarkRoutePlanExecutionReviewPacket', 'legal document route plan execution review packet POST binding'),
  () => assertIncludes(maintenancePage, 'Legal document benchmark route plan execution review packet', 'legal document route plan execution review packet panel'),
  () => assertIncludes(maintenancePage, 'Refresh review packet', 'legal document route plan execution review packet button'),
  () => assertIncludes(maintenancePage, 'review_items', 'legal document route plan execution review packet rows'),
  () => assertIncludes(maintenancePage, 'claim_review_rows', 'legal document route plan execution review packet claim rows'),
  () => assertIncludes(maintenancePage, 'review_packet_policy', 'legal document route plan execution review packet policy'),
  ...
  () =>
    assertBefore(
      ...
      'legal document route plan follows coverage',
    ),
  () =>
    assertBefore(
      maintenancePage,
  ...
  () =>
    assertBefore(
      ...
      'legal document route plan execution review packet follows handoff',
    ),
  () =>
    assertBefore(
      maintenancePage,
