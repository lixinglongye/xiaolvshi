...
const checks = [
  ...
  () => assertIncludes(modelOpsPage, 'legacy_media_unrouted', 'model-ops AIHub endpoint route legacy media flag'),
  ...
  () =>
    assertBefore(
      ...
      'model-ops AIHub endpoint route coverage precedes catalog source audit',
    ),
