...
AIHUB_ENDPOINT_SPECS: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "aihub-embeddings",
        "endpoint_path": "/api/v1/aihub/embeddings",
        "method": "POST",
        "router_handler": "generate_embeddings",
        "service_method": "AIHubService.embed_text",
        "response_model": "EmbedTextResponse",
        "task": "embedding",
        "default_model": task_default_model("embedding"),
        "model_source": "request.model or APP_AI_EMBEDDING_MODEL",
        "uses_runtime_router": True,
        "uses_budget_decision": True,
        "records_route_telemetry": True,
        "records_usage": True,
        ...
        "route_mode": "cheap_first_embedding_runtime",
        "route_gap_reason_codes": (),
    },
    {
        "id": "aihub-genimg",
