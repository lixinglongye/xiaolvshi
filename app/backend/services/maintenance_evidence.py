    ...
    def build_profile(self, language: Language = "en") -> dict:
        ...
        return {
            ...
            "application_guardrails": [
                ...
                "Selected-source Legal RAG evidence is metadata propagation only; do not claim full generated-report citation validation against selected sources until merged evidence exists.",
                "Generated document CRUD creation is quota guarded; do not claim direct case/deep-review generation quota enforcement until merged evidence exists.",
    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Deterministic gates, legal document template coverage, contract clause extraction schema, export-readiness checks, research-backed legal AI backlog planning, public benchmark sampling plans, quick laptop-safe fixture suites, small legal document benchmark fixtures, deterministic legal document benchmark suite checks, small synthetic corpus expansion, RAG failure fixtures, legal source freshness policy, durable source index planning, metadata-only RAG index binding and route exposure, metadata-only research context cache/copy controls, selected-source request metadata propagation, fixture-level Gemini/NewAPI model matrices, cheap-first fixture prompt packs, safe gateway manifests, laptop-safe fixture run plans, one-at-a-time local run packages, response normalizers, one-step local run reviews, cheap-first run reports, evidence bundles, archive-safe result summaries, fixture smoke tests, and fixture improvement plans verify report structure, grounding, pending-fact handling, disclaimers, and small legal document coverage before review.",
                responsibility="Quality gate tuning, legal template matrix review, contract clause schema review, export-readiness review, research backlog review, public benchmark sampler review, document benchmark fixture review, benchmark-suite review, small corpus review, RAG failure fixture review, source freshness, durable-index, RAG-index-binding, selected-source metadata review, and route review, quick-suite review, legal fixture model matrix review, prompt coverage, safe gateway manifest upkeep, fixture run-plan, local-package, response-normalizer, local-run-review, result-archive, run-report, and evidence-bundle maintenance, smoke coverage, prompt/schema improvement planning, regression tests, and release criteria maintenance.",
            ...
            MaintenanceSignal(
                ...
                description="The repository documents target users, workflow priorities, feedback lifecycle, billing quota evidence, entitlement quota binding, usage routes and preflight, generated-document CRUD quota guards, local payment reconciliation policy, frontend runtime API helpers, document-generation quota attempts, migration planning, maintenance metrics, heartbeat evidence format, and application-safe claims.",
                responsibility="User workflow research, feedback lifecycle review, billing quota, entitlement binding, generated-document quota guard, local payment reconciliation, usage-route, preflight, API-helper, and migration review, maintenance roadmap updates, heartbeat evidence review, and support-application accuracy.",
