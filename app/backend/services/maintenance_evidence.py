    ...
    def build_profile(self, language: Language = "en") -> dict:
        ...
        return {
            ...
            "application_guardrails": [
                ...
                "The ModelOps legal fixture cheap-first benchmark gate is metadata-only small legal-document benchmark/risk evidence using redacted fixture ids, document case ids, fact-consistency case ids, expected issue tags, amount/date/fact consistency counts, cost metadata, and escalation metadata only; it does not call NewAPI, Gemini, OpenAI, Google, gateways, or the network, and it does not include real legal text, prompts, model outputs, credentials, or emails.",
                "The ModelOps legal fixture cheap-first default promotion packet is metadata-only maintainer review evidence; it does not write configuration, call NewAPI, Gemini, OpenAI, Google, gateways, or the network, shift traffic, or include real legal text, fixture snippets, generated document text, prompts, model outputs, credentials, or emails.",
