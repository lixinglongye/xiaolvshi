    ...
    def build_profile(self, language: Language = "en") -> dict:
        ...
        return {
            ...
            "application_guardrails": [
                ...
                "Generated document CRUD, case generation, and deep-review first-principles generation are quota guarded; do not claim real payment provider settlement or universal cross-endpoint quota coverage until merged evidence exists.",
    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Citation, evidence, source freshness, exhibit package, grounding, case intake, workbench persistence planning, runtime state binding and routes, privacy-safe case edit runtime events, selected-source request metadata, matter intake readiness, deadline-risk, deadline validation, delivery-risk, delivery transparency, and graph services flag weak legal authorities, stale sources, missing reviewable citations, missing evidence plans, incomplete intake fields, urgent deadlines, missing client disclosures, unsupported legal claims, and blocking pending facts.",
                responsibility="Legal-source freshness review, issue triage, exhibit package review, grounding quick-audit review, selected-source metadata review, workbench persistence, runtime-binding, router review, privacy-safe edit-event review, intake completeness review, matter-readiness review, deadline-risk and deadline-validation review, client-delivery checklist and transparency review, and evidence completeness checks.",
            ...
            MaintenanceSignal(
                ...
                description="The repository documents target users, workflow priorities, feedback lifecycle, billing quota evidence, entitlement quota binding, usage routes and preflight, generated-document CRUD, case generation, and deep-review document quota guards, local payment reconciliation policy, frontend runtime API helpers, document-generation quota attempts, migration planning, maintenance metrics, heartbeat evidence format, and application-safe claims.",
                responsibility="User workflow research, feedback lifecycle review, billing quota, entitlement binding, generated-document, case-generation, and deep-review document quota guards, local payment reconciliation, usage-route, preflight, API-helper, and migration review, maintenance roadmap updates, heartbeat evidence review, and support-application accuracy.",
