    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            MaintenanceSignal(
                ...
                description="OpenAI-compatible gateway routing prefers cheaper Gemini models for routine tasks and keeps defaults pinned to stable lifecycle-safe models with safe gateway health planning, default recommendation snapshots, price-refresh monitoring, cost regression snapshots, route telemetry persistence planning, and sanitized probe evaluation.",
                responsibility="Model catalog maintenance, budget policy review, default recommendation review, price-refresh review, cost regression review, route telemetry privacy review, gateway compatibility updates, gateway health-plan review, sanitized probe evaluation, and Gemini lifecycle policy review.",
            ...
            MaintenanceSignal(
                ...
                description="Deterministic gates, legal document template coverage, contract clause extraction schema, export-readiness checks, research-backed legal AI backlog planning, public benchmark sampling plans, quick laptop-safe fixture suites, small legal document benchmark fixtures, small synthetic corpus expansion, RAG failure fixtures, legal source freshness policy, durable source index planning, metadata-only RAG index binding, fixture-level Gemini/NewAPI model matrices, cheap-first fixture prompt packs, safe gateway manifests, laptop-safe fixture run plans, one-at-a-time local run packages, response normalizers, one-step local run reviews, cheap-first run reports, evidence bundles, archive-safe result summaries, fixture smoke tests, and fixture improvement plans verify report structure, grounding, pending-fact handling, disclaimers, and small legal document coverage before review.",
                responsibility="Quality gate tuning, legal template matrix review, contract clause schema review, export-readiness review, research backlog review, public benchmark sampler review, document benchmark fixture review, small corpus review, RAG failure fixture review, source freshness, durable-index, and RAG-index-binding review, quick-suite review, legal fixture model matrix review, prompt coverage, safe gateway manifest upkeep, fixture run-plan, local-package, response-normalizer, local-run-review, result-archive, run-report, and evidence-bundle maintenance, smoke coverage, prompt/schema improvement planning, regression tests, and release criteria maintenance.",
            ...
            MaintenanceSignal(
                ...
                description="Citation, evidence, source freshness, exhibit package, grounding, case intake, workbench persistence planning, runtime state binding, matter intake readiness, deadline-risk, deadline validation, delivery-risk, delivery transparency, and graph services flag weak legal authorities, stale sources, missing reviewable citations, missing evidence plans, incomplete intake fields, urgent deadlines, missing client disclosures, unsupported legal claims, and blocking pending facts.",
                responsibility="Legal-source freshness review, issue triage, exhibit package review, grounding quick-audit review, workbench persistence and runtime-binding review, intake completeness review, matter-readiness review, deadline-risk and deadline-validation review, client-delivery checklist and transparency review, and evidence completeness checks.",
            ...
            MaintenanceSignal(
                ...
                description="The project defines least-privilege case collaboration roles, role-operation permissions, client-only scopes, sensitive-operation approval rules, matter audit retention buckets, forbidden audit fields, and audit event requirements before richer team workflows are exposed.",
                responsibility="Role matrix review, permission decision review, sensitive-operation audit coverage, matter audit retention review, client access minimization, and firm-retention policy alignment.",
            ...
            MaintenanceSignal(
                ...
                description="The repository documents target users, workflow priorities, feedback lifecycle, billing quota evidence, entitlement quota binding, migration planning, maintenance metrics, heartbeat evidence format, and application-safe claims.",
                responsibility="User workflow research, feedback lifecycle review, billing quota, entitlement binding, and migration review, maintenance roadmap updates, heartbeat evidence review, and support-application accuracy.",
