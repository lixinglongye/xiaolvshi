    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Deterministic gates, cheap-first fixture prompt packs, safe gateway manifests, laptop-safe fixture run plans, fixture smoke tests, and fixture improvement plans verify report structure, grounding, pending-fact handling, disclaimers, and small legal document coverage before review.",
                responsibility="Quality gate tuning, legal fixture prompt coverage, safe gateway manifest upkeep, fixture run-plan maintenance, smoke coverage, prompt/schema improvement planning, regression tests, and release criteria maintenance.",
