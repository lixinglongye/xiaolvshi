    ...
    def build_profile(self, language: Language = "en") -> dict:
        ...
        return {
            ...
            "application_guardrails": [
                ...
                "Generated document CRUD and case generation are quota guarded; do not claim deep-review first-principles generation quota enforcement until merged evidence exists.",
    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Deterministic gates, legal document template coverage, contract clause extraction schema, export-readiness checks, research-backed legal AI backlog planning, LegalBench/LexGLUE/COLIEE research registry mapping, public benchmark sampling plans, quick laptop-safe fixture suites, small legal document benchmark fixtures, deterministic legal document benchmark suite checks, small synthetic corpus expansion, RAG failure fixtures, legal source freshness policy, durable source index planning, metadata-only RAG index binding and route exposure, metadata-only research context cache/copy controls, selected-source request metadata propagation and citation validation, fixture-level Gemini/NewAPI model matrices, cheap-first fixture prompt packs, safe gateway manifests, laptop-safe fixture run plans, one-at-a-time local run packages, response normalizers, one-step local run reviews, cheap-first run reports, evidence bundles, archive-safe result summaries, fixture smoke tests, and fixture improvement plans verify report structure, grounding, pending-fact handling, disclaimers, and small legal document coverage before review.",
                responsibility="Quality gate tuning, legal template matrix review, contract clause schema review, export-readiness review, research backlog review, benchmark research registry review, public benchmark sampler review, document benchmark fixture review, benchmark-suite review, small corpus review, RAG failure fixture review, source freshness, durable-index, RAG-index-binding, selected-source metadata and citation validation review, and route review, quick-suite review, legal fixture model matrix review, prompt coverage, safe gateway manifest upkeep, fixture run-plan, local-package, response-normalizer, local-run-review, result-archive, run-report, and evidence-bundle maintenance, smoke coverage, prompt/schema improvement planning, regression tests, and release criteria maintenance.",
            ...
            MaintenanceSignal(
                ...
                description="The report and case UI expose quality, citation, evidence, risk, delivery, lawyer-review, runtime event, selected-source legal RAG context, and quota-consumption signals to reviewers.",
                responsibility="Reviewer workflow usability, report mapping, case page runtime wiring, selected-source request metadata wiring, and frontend type maintenance.",
