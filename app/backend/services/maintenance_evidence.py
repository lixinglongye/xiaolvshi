    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Deterministic gates, cheap-first fixture prompt packs, fixture smoke tests, and fixture improvement plans verify report structure, grounding, pending-fact handling, disclaimers, and small legal document coverage before review.",
                responsibility="Quality gate tuning, legal fixture prompt coverage, smoke coverage, prompt/schema improvement planning, regression tests, and release criteria maintenance.",
