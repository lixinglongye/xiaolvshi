    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Citation, evidence, source freshness, exhibit package, grounding, case intake, workbench persistence planning, runtime state binding and routes, matter intake readiness, deadline-risk, deadline validation, delivery-risk, delivery transparency, and graph services flag weak legal authorities, stale sources, missing reviewable citations, missing evidence plans, incomplete intake fields, urgent deadlines, missing client disclosures, unsupported legal claims, and blocking pending facts.",
                responsibility="Legal-source freshness review, issue triage, exhibit package review, grounding quick-audit review, workbench persistence, runtime-binding, and router review, intake completeness review, matter-readiness review, deadline-risk and deadline-validation review, client-delivery checklist and transparency review, and evidence completeness checks.",
            ...
            MaintenanceSignal(
                ...
                description="The repository documents target users, workflow priorities, feedback lifecycle, billing quota evidence, entitlement quota binding, billing usage routes, frontend runtime API helpers, migration planning, maintenance metrics, heartbeat evidence format, and application-safe claims.",
                responsibility="User workflow research, feedback lifecycle review, billing quota, entitlement binding, usage-route, API-helper, and migration review, maintenance roadmap updates, heartbeat evidence review, and support-application accuracy.",
