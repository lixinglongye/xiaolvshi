    ...
    def build_profile(self, language: Language = "en") -> dict:
        ...
        return {
            ...
            "application_guardrails": [
                ...
                "Keep future claims for payment provider reconciliation, selected-source citation propagation, and server-side deep-review quota enforcement out of support applications until merged evidence exists.",
    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Citation, evidence, source freshness, exhibit package, grounding, case intake, workbench persistence planning, runtime state binding and routes, privacy-safe case edit runtime events, matter intake readiness, deadline-risk, deadline validation, delivery-risk, delivery transparency, and graph services flag weak legal authorities, stale sources, missing reviewable citations, missing evidence plans, incomplete intake fields, urgent deadlines, missing client disclosures, unsupported legal claims, and blocking pending facts.",
                responsibility="Legal-source freshness review, issue triage, exhibit package review, grounding quick-audit review, workbench persistence, runtime-binding, router review, privacy-safe edit-event review, intake completeness review, matter-readiness review, deadline-risk and deadline-validation review, client-delivery checklist and transparency review, and evidence completeness checks.",
            ...
            MaintenanceSignal(
                ...
                description="The report and case UI expose quality, citation, evidence, risk, delivery, lawyer-review, runtime event, legal RAG context, and quota-consumption signals to reviewers.",
                responsibility="Reviewer workflow usability, report mapping, case page runtime wiring, and frontend type maintenance.",
            ...
            MaintenanceSignal(
                ...
                description="The repository documents target users, workflow priorities, feedback lifecycle, billing quota evidence, entitlement quota binding, usage routes and preflight, frontend runtime API helpers, document-generation quota attempts, migration planning, maintenance metrics, heartbeat evidence format, and application-safe claims.",
                responsibility="User workflow research, feedback lifecycle review, billing quota, entitlement binding, usage-route, preflight, API-helper, and migration review, maintenance roadmap updates, heartbeat evidence review, and support-application accuracy.",
