    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Citation, evidence, grounding, case intake, deadline-risk, delivery-risk, and graph services flag weak legal authorities, missing reviewable citations, missing evidence plans, incomplete intake fields, urgent deadlines, missing client disclosures, unsupported legal claims, and blocking pending facts.",
                responsibility="Legal-source review support, issue triage, grounding quick-audit review, intake completeness review, deadline-risk review, client-delivery checklist review, and evidence completeness checks.",
