    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="The project computes deterministic risk scores and combines quality, citation, evidence, lawyer-review workflow, document delivery manifest, and risk signals into client delivery decisions.",
                responsibility="Release readiness review, lawyer-review workflow routing, document delivery manifest review, and delivery-blocker management.",
