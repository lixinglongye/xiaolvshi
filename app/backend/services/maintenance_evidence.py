    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            MaintenanceSignal(
                ...
                description="OpenAI-compatible gateway routing prefers cheaper Gemini models for routine tasks and keeps defaults pinned to stable lifecycle-safe models with safe gateway health planning, default recommendation snapshots, and sanitized probe evaluation.",
                responsibility="Model catalog maintenance, budget policy review, default recommendation review, gateway compatibility updates, gateway health-plan review, sanitized probe evaluation, and Gemini lifecycle policy review.",
