    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            MaintenanceSignal(
                ...
                description="OpenAI-compatible gateway routing prefers cheaper Gemini models for routine tasks and keeps defaults pinned to stable lifecycle-safe models.",
                responsibility="Model catalog maintenance, budget policy review, gateway compatibility updates, and Gemini lifecycle policy review.",
