    ...
    def build_profile(self, language: Language = "en") -> dict:
        ...
        return {
            ...
            "application_guardrails": [
                ...
                "The ModelOps runtime explicit model fit gate is metadata-only runtime route evidence; it runs sanitized task/model scenarios through local routing to surface unknown gateway pass-through, explicit over-budget exceptions, local downgrades, cheap-first alignment, and observed gateway fit review states without NewAPI, Gemini, OpenAI, Google, gateway, app-AI, model, or network calls, configuration writes, runtime behavior changes, default changes, traffic shifts, request or response bodies, headers, messages, prompts, raw payloads, legal text, model outputs, gateway responses, credentials, emails, or user identifiers.",
