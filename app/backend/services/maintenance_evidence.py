    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            MaintenanceSignal(
                ...
                description="OpenAI-compatible gateway routing prefers cheaper Gemini models for routine tasks and keeps defaults pinned to stable lifecycle-safe models with safe gateway health planning.",
                responsibility="Model catalog maintenance, budget policy review, gateway compatibility updates, gateway health-plan review, and Gemini lifecycle policy review.",
            ...
            MaintenanceSignal(
                ...
                description="Deterministic gates, public benchmark sampling plans, quick laptop-safe fixture suites, fixture-level Gemini/NewAPI model matrices, cheap-first fixture prompt packs, safe gateway manifests, laptop-safe fixture run plans, cheap-first run reports, evidence bundles, fixture smoke tests, and fixture improvement plans verify report structure, grounding, pending-fact handling, disclaimers, and small legal document coverage before review.",
                responsibility="Quality gate tuning, public benchmark sampler review, quick-suite review, legal fixture model matrix review, prompt coverage, safe gateway manifest upkeep, fixture run-plan, run-report, and evidence-bundle maintenance, smoke coverage, prompt/schema improvement planning, regression tests, and release criteria maintenance.",
            ...
            MaintenanceSignal(
                ...
                description="Citation, evidence, and grounding services flag weak legal authorities, missing reviewable citations, missing evidence plans, unsupported legal claims, and blocking pending facts.",
                responsibility="Legal-source review support, issue triage, grounding quick-audit review, and evidence completeness checks.",
