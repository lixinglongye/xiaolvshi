    ...
    def _signals(self) -> list[MaintenanceSignal]:
        return [
            ...
            MaintenanceSignal(
                ...
                description="Citation, evidence, exhibit package, grounding, case intake, matter intake readiness, deadline-risk, deadline validation, delivery-risk, delivery transparency, and graph services flag weak legal authorities, missing reviewable citations, missing evidence plans, incomplete intake fields, urgent deadlines, missing client disclosures, unsupported legal claims, and blocking pending facts.",
                responsibility="Legal-source review support, issue triage, exhibit package review, grounding quick-audit review, intake completeness review, matter-readiness review, deadline-risk and deadline-validation review, client-delivery checklist and transparency review, and evidence completeness checks.",
            ...
            MaintenanceSignal(
                ...
                description="The project defines least-privilege case collaboration roles, client-only scopes, sensitive-operation approval rules, matter audit retention buckets, forbidden audit fields, and audit event requirements before richer team workflows are exposed.",
                responsibility="Role matrix review, sensitive-operation audit coverage, matter audit retention review, client access minimization, and firm-retention policy alignment.",
            ...
            MaintenanceSignal(
                ...
                description="The project computes deterministic risk scores and combines quality, citation, evidence, lawyer-review workflow, and risk signals into client delivery decisions.",
                responsibility="Release readiness review, lawyer-review workflow routing, and delivery-blocker management.",
            ...
            MaintenanceSignal(
                ...
                description="The repository documents target users, workflow priorities, maintenance metrics, heartbeat evidence format, and application-safe claims.",
                responsibility="User workflow research, maintenance roadmap updates, heartbeat evidence review, and support-application accuracy.",
