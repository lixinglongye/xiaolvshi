...
class ContinuousUpdateLedgerService:
    ...
    def _entries(self) -> list[LedgerEntry]:
        return [
            ...
            LedgerEntry(
                id="case-workbench-persistent-state",
                title="Case workbench persistent state",
                category="product_planning",
                size="large",
                status="planned",
                impact="Persist parties, facts, tasks, deadlines, and evidence graph state behind the workbench payload.",
                evidence_paths=("app/backend/services/case_workbench_payload.py",),
                release_gate_links=("case-workbench-payload",),
                user_need_ids=("case-workbench",),
            ),
            LedgerEntry(
                id="legal-source-durable-index",
                title="Legal source durable index",
                category="benchmark",
                size="large",
                status="planned",
                impact="Persist metadata-only source index entries for jurisdiction-aware retrieval without storing raw client material.",
                evidence_paths=("app/backend/services/legal_source_ingestion_metadata.py",),
                release_gate_links=("legal-source-ingestion-metadata", "legal-source-freshness-policy"),
                user_need_ids=("grounded-legal-output",),
            ),
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Map quota counter schema into database migrations and privacy-safe repository methods.",
                evidence_paths=("app/backend/services/billing_quota_persistence_plan.py",),
                release_gate_links=("billing-quota-persistence-plan",),
