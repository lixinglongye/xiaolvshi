    ...
    def _entries(self) -> list[LedgerEntry]:
        return [
            ...
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Implement database-backed case workbench state repository methods from the persistence plan.",
                evidence_paths=("app/backend/services/case_workbench_persistence_plan.py",),
                release_gate_links=("case-workbench-persistence-plan",),
                user_need_ids=("case-workbench",),
            ),
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Implement durable metadata-only legal source index storage and retrieval filters from the durable index plan.",
                evidence_paths=("app/backend/services/legal_source_durable_index_plan.py",),
                release_gate_links=("legal-source-durable-index-plan",),
                user_need_ids=("grounded-legal-output",),
            ),
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Implement migrations and repository methods for quota counters after the migration plan is reviewed.",
                evidence_paths=("app/backend/services/billing_quota_migration_plan.py",),
                release_gate_links=("billing-quota-migration-plan",),
                user_need_ids=("billing-entitlements",),
            ),
        ]
