...
class ContinuousUpdateLedgerService:
    ...
    def _entries(self) -> list[LedgerEntry]:
        return [
            ...
            LedgerEntry(
                id="case-workbench-runtime-route-binding",
                title="Case workbench runtime route binding",
                category="product_planning",
                size="large",
                status="planned",
                impact="Expose repository-backed case workbench state updates through authenticated runtime routes and frontend edit actions.",
                evidence_paths=("app/backend/services/case_workbench_state_repository.py",),
                release_gate_links=("case-workbench-state-repository",),
                user_need_ids=("case-workbench", "reviewer-visibility"),
            ),
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Bind legal RAG source selection to the durable metadata index and evaluate retrieval against freshness and jurisdiction fixtures.",
                evidence_paths=("app/backend/services/legal_source_index_repository.py",),
                release_gate_links=("legal-source-index-repository", "legal-rag-evaluation"),
                user_need_ids=("grounded-legal-output",),
            ),
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Use persisted quota counters in entitlement responses and report-generation consumption paths.",
                evidence_paths=("app/backend/services/billing_quota_repository.py",),
                release_gate_links=("billing-quota-repository", "billing-usage-quota-policy"),
                user_need_ids=("billing-entitlements", "low-cost-routing"),
            ),
        ]
