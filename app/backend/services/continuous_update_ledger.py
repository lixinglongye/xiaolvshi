    ...
    def _entries(self) -> list[LedgerEntry]:
        return [
            ...
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Expose repository-backed case workbench state payloads, state events, and audit trails through authenticated case routes.",
                evidence_paths=("app/backend/services/case_workbench_runtime_binding.py",),
                release_gate_links=("case-workbench-runtime-binding",),
                user_need_ids=("case-workbench", "reviewer-visibility"),
            ),
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Expose durable-index retrieval plans and legal RAG evaluation payloads through user-facing research routes.",
                evidence_paths=("app/backend/services/legal_rag_index_binding.py",),
                release_gate_links=("legal-rag-index-binding",),
                user_need_ids=("grounded-legal-output",),
            ),
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Bind persisted quota usage into entitlement responses and report-generation consumption paths.",
                evidence_paths=("app/backend/services/billing_entitlement_quota_binding.py",),
                release_gate_links=("billing-entitlement-quota-binding",),
                user_need_ids=("billing-entitlements", "low-cost-routing"),
            ),
        ]
