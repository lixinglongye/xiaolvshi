    ...
    def _entries(self) -> list[LedgerEntry]:
        return [
            ...
            LedgerEntry(
                ...
                size="medium",
                status="shipped",
                impact="Adds metadata-only runtime explicit model fit evidence that runs local sanitized task/model scenarios through the runtime router to surface unknown gateway pass-through, explicit over-budget exceptions, local downgrade enforcement, cheap-first alignment, observed gateway fit review states, and privacy/claim boundaries without live gateway calls, model calls, account inventory validation, configuration writes, runtime behavior changes, default changes, traffic shifts, API keys, Authorization headers, request bodies, response bodies, headers, messages, prompts, raw payloads, legal text, model outputs, gateway responses, emails, user identifiers, or credentials.",
                evidence_paths=(
            ...
            LedgerEntry(
                ...
                size="medium",
                status="shipped",
                impact="Converts sanitized route reason_code_counts into cheap-first/Gemini route hotspots for over_task_budget, operator_review_required, unknown_catalog_model, gateway_passthrough, and unknown_reason_code pressure without storing prompts, raw legal text, payloads, emails, credentials, or model output.",
                evidence_paths=(
                    "app/backend/services/route_telemetry_ops_summary.py",
                    "app/backend/services/route_telemetry_triage_queue.py",
                    "app/backend/services/route_telemetry_repository.py",
