    ...
    def _entries(self) -> list[LedgerEntry]:
        return [
            ...
            LedgerEntry(
                ...
                size="medium",
                status="shipped",
                impact="Adds a user-facing feedback capture preview and ticket enrichment path that links feedback to triage, roadmap needs, release gates, lifecycle blockers, and privacy-safe support notes.",
                evidence_paths=(
