    ...
    def _entries(self) -> list[LedgerEntry]:
        return [
            ...
            LedgerEntry(
                ...
                size="medium",
                status="shipped",
                impact="Adds a metadata-only Legal RAG retrieval observation gate that evaluates sanitized local retrieval observation rows for selected-source citation validation, source coverage, top-k depth, jurisdiction/freshness, cheap-first routing decisions, and answer-release actions without NewAPI/Gemini/model calls, gateway calls, network calls, dataset downloads, source-id echoing, raw query, raw retrieved context, raw legal text, prompts, model outputs, or credentials.",
                evidence_paths=(
