    ...
    def _entries(self) -> list[LedgerEntry]:
        return [
            ...
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Bind case detail editing actions to privacy-safe workbench state events and show repository-backed section/audit state.",
                evidence_paths=("app/frontend/src/lib/workbenchRuntimeApi.ts",),
                release_gate_links=("frontend-runtime-api-client-bindings", "case-workbench-runtime-router"),
                user_need_ids=("case-workbench", "reviewer-visibility"),
            ),
            LedgerEntry(
                ...
                size="large",
                status="planned",
                impact="Show indexed source selection, stale-source warnings, and missing coverage reasons inside the case research workflow.",
                evidence_paths=("app/frontend/src/lib/legalRagApi.ts",),
                release_gate_links=("frontend-runtime-api-client-bindings", "legal-rag-index-route"),
                user_need_ids=("grounded-legal-output",),
            ),
            LedgerEntry(
                ...
                size="medium",
                status="planned",
                impact="Surface persisted quota usage and deterministic over-limit reasons in the main workspace and team billing surfaces.",
                evidence_paths=("app/frontend/src/lib/billingUsageApi.ts",),
                release_gate_links=("frontend-runtime-api-client-bindings", "billing-quota-consumption-route"),
                user_need_ids=("billing-entitlements", "low-cost-routing"),
            ),
        ]
