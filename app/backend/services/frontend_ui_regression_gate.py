        ...
        return {
            ...
            "failure_modes": [
                ...
                },
                {
                    ...
                    "page": "/model-ops",
                    "current_control": "Typecheck/build plus npm run ui:regression keep the Gemini official model family roadmap evidence panel, API binding, family rows, roadmap rows, cheap-first evidence rows, and privacy boundary in the ModelOps source contract.",
                    "regression_target": "Add browser-level mocked official-family roadmap checks for covered text defaults, review-only Gemini 3/image families, live/audio/embedding/TTS gaps, and forbidden raw request/model fields.",
                },
                {
                ...
                {
                    "id": "route-telemetry-result-archive-ui-contract-regresses",
                    "page": "/model-ops",
                    "current_control": "Typecheck/build plus npm run ui:regression keep route telemetry result archive and cost ledger rows, archive ordering, endpoint binding, privacy boundaries, no config writes, and no gateway calls in the ModelOps source contract.",
                    "regression_target": "Add browser-level mocked route telemetry result-archive API checks for archive_rows, cost_ledger_rows, release_review_rows, metadata-only flags, no configuration writes, no gateway calls, and forbidden raw request/model fields.",
                },
                {
