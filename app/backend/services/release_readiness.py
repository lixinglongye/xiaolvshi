    ...
    def _checks(self) -> list[ReleaseCheck]:
        return [
            ...
            ReleaseCheck(
                ...
                validation_command="python -m pytest tests/test_feedback_capture_plan.py tests/test_feedback_lifecycle_policy.py tests/test_feedback_roadmap_alignment.py -q && cd ../frontend && npm run typecheck && npm run ui:regression",
                manual_note="This previews and enriches user feedback with metadata-only triage, roadmap, release-gate, and lifecycle summaries; it does not call models, store external evidence, or echo raw feedback text in preview summaries.",
            ),
            ReleaseCheck(
