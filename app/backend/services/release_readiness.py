    ...
    def _checks(self) -> list[ReleaseCheck]:
        return [
            ...
            ReleaseCheck(
                ...
                manual_note="This is metadata-only runtime explicit model fit evidence for sanitized task/model scenarios, unknown gateway pass-through review, explicit over-budget exceptions, local downgrade visibility, cheap-first enforcement signals, observed gateway fit linkage, and privacy/claim boundaries; it does not call NewAPI, Gemini, OpenAI, Google, gateways, app AI endpoints, models, or the network, does not write configuration, change runtime behavior, change defaults, shift traffic, validate an account inventory, or include API keys, Authorization headers, request bodies, response bodies, headers, messages, prompts, raw payloads, legal text, model outputs, gateway responses, credentials, emails, or user identifiers.",
            ),
            ReleaseCheck(
