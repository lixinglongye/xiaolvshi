    ...
    def _checks(self) -> list[ReleaseCheck]:
        return [
            ...
            ReleaseCheck(
                ...
                manual_note="This combines plan limits with persisted quota snapshots and idempotent usage events; deep-review consumption routes and payment provider reconciliation remain separate.",
            ),
            ReleaseCheck(
