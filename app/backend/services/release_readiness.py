    ...
    def _checks(self) -> list[ReleaseCheck]:
        return [
            ...
            ReleaseCheck(
                ...
                validation_command="python -m pytest tests/test_legal_review_benchmark.py tests/test_legal_fixture_prompt_pack.py tests/test_legal_fixture_gateway_manifest.py tests/test_legal_fixture_run_plan.py tests/test_legal_fixture_run_report.py tests/test_legal_fixture_improvement.py -q",
            ),
            ReleaseCheck(
