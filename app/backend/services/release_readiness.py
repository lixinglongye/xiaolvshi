    ...
    def _checks(self) -> list[ReleaseCheck]:
        return [
            ...
            ReleaseCheck(
                ...
                manual_note="This is metadata-only AIHub endpoint route coverage gate evidence for endpoint inventory, runtime-router coverage, budget-decision coverage, route telemetry coverage, response route payload coverage, task inference response coverage, media usage-unit coverage, and media/speech catalog review gaps; it does not call NewAPI, Gemini, OpenAI, Google, gateways, app AI endpoints, models, or the network, does not write configuration or shift traffic, and does not include request bodies, response bodies, headers, prompts, raw payloads, legal text, model outputs, gateway responses, credentials, emails, or user identifiers.",
            ),
            ReleaseCheck(
