    ...
    def _checks(self) -> list[ReleaseCheck]:
        return [
            ...
            ReleaseCheck(
                ...
                manual_note="This is metadata-only small legal-document cheap-first Gemini benchmark/risk gate evidence exposed in the AIHub ModelOps payload and ModelOps UI using redacted fixture ids, document case ids, fact-consistency case ids, linked cheap-first calibration task ids, calibration decisions, release gates, expected issue counts, amount/date/fact consistency counts, cost metadata, document benchmark pass/fail counts, coverage-gap counts, and escalation metadata only; it does not call NewAPI, Gemini, OpenAI, Google, gateways, or the network, and it does not include real legal text, fixture snippets, prompts, generated document text, calibration payloads, model outputs, credentials, or emails.",
            ),
            ReleaseCheck(
