    ...
    def build_decision(self, signals: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        checks = [
            ...
            self._check_signal(
                ...
                "legal_benchmark_default_promotion_bridge",
                data.get("legal_benchmark_default_promotion_bridge"),
                fail_reason="Legal benchmark default-promotion bridge has blocked legal fixture or Gemini lifecycle evidence.",
                warn_reason="Legal benchmark default-promotion bridge requires maintainer review before default promotion.",
            ),
            self._check_signal(
        ...
        return {
            ...
            "method": {
                ...
                "notes": [
                    ...
                    "Requires the legal benchmark default-promotion bridge so fixture, regression, handoff, and Gemini lifecycle drift evidence are reviewed together.",
            ...
            "promotion_policy": {
                ...
                "legal_benchmark_default_promotion_policy": "Legal benchmark default-promotion bridge must be reviewed before legal-task Gemini defaults move.",
        ...
        *,
        ...
        return {
            ...
            "source_summary": {
                ...
                "source_count": self._safe_int(summary.get("source_count")),
                "promotion_row_count": self._safe_int(summary.get("promotion_row_count")),
                "promotion_ready_count": self._safe_int(summary.get("promotion_ready_count")),
                "promotion_blocked_count": self._safe_int(summary.get("promotion_blocked_count")),
                "stable_flash_lite_default_count": self._safe_int(summary.get("stable_flash_lite_default_count")),
                "blocked_default_count": self._safe_int(summary.get("blocked_default_count")),
                "review_default_count": self._safe_int(summary.get("review_default_count")),
            },
            "reason": reason,
        }
