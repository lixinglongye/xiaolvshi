    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ProductFeatureGap(
                ...
                current_state="Case primitives, dashboard payload contract, notification policy, persistence plan, and validated state repository exist, but frontend workspace editing and live risk-state updates are not complete.",
                ...
                next_actions=(
                    "Bind the state repository to case workbench routes and frontend editing actions.",
            ...
            ProductFeatureGap(
                ...
                module="billing",
                current_state="Entitlement checks, local quota policy, privacy-safe quota persistence and migration plans, and a quota counter repository exist, but product packaging, invoice states, payment provider integration, and entitlement response wiring are incomplete.",
                ...
                next_actions=(
                    "Wire the quota repository into entitlement checks and report-generation consumption.",
            ...
            ProductFeatureGap(
                ...
                current_state="Knowledge, RAG audits, failure fixtures, source-freshness policy, source ingestion metadata contracts, durable index plan, and metadata-only index repository exist, but live retrieval binding and evaluation are incomplete.",
                ...
                next_actions=(
                    "Bind legal RAG retrieval to the metadata-only index repository.",
                    "Use jurisdiction, effective-date, freshness, and dedupe filters in source selection.",
