        ...
        return (
            ...
            ProductFeatureGap(
                ...
                next_actions=(
                    ...
                    "Wire evidence-catalog export preflight and case export readiness checks into the live report export buttons.",
                ),
            ),
            ProductFeatureGap(
                id="contract-review",
            ...
            ProductFeatureGap(
                ...
                module="evidence",
                current_state="Evidence services, a metadata-only evidence bundle integrity checker, and an evidence-catalog export preflight exist, covering duplicates, missing sources, missing proof purposes, exhibit package policy, page anchors, three-factor review, and date/amount/checksum gaps; exhibit organization, chain-of-custody notes, frontend export gating, and case linking still need a fuller workflow.",
                ...
                next_actions=(
                    "Expose the evidence-catalog export preflight in the case detail download flow.",
