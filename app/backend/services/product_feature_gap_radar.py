    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ...
            ProductFeatureGap(
                ...
                module="maintenance",
                current_state="The 100+ update ledger, heartbeat evidence export, continuous session evidence validator, metadata-only continuous session timeline, and git history cadence evidence exist, including max-gap, commit-window, credential-scan, low-resource legal fixture, blocker, privacy-boundary, and 100+ update-count checks. The reviewer-facing product still lacks persisted real session records and a fully interactive timeline that joins commits, tests, pushes, credential scans, low-resource benchmark events, release reviews, and support-claim readiness.",
                ...
                next_actions=(
                    ...
                    "Join git cadence evidence with test, push, credential-scan, low-resource fixture, and release-review events.",
