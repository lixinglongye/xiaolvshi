    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ProductFeatureGap(
                ...
                current_state="Case primitives, dashboard payload contract, notification policy, persistence plan, validated state repository, and runtime binding facade exist, but authenticated runtime routes, frontend workspace editing, and live risk-state updates are not complete.",
                ...
                next_actions=(
                    "Expose runtime state payloads and audit trails through authenticated case workbench routes.",
            ...
            ProductFeatureGap(
                ...
                module="billing",
                current_state="Entitlement checks, local quota policy, privacy-safe quota persistence and migration plans, quota counter repository, and entitlement/quota binding facade exist, but product packaging, invoice states, payment provider integration, and live consumption-route wiring are incomplete.",
                ...
                next_actions=(
                    "Expose persisted quota snapshots and deterministic over-limit reasons in entitlement responses.",
            ...
            ProductFeatureGap(
                ...
                current_state="Knowledge, RAG audits, failure fixtures, source-freshness policy, source ingestion metadata contracts, durable index plan, metadata-only index repository, and indexed retrieval-plan binding exist, but user-facing research routes and case UI integration are incomplete.",
                ...
                next_actions=(
                    "Expose durable-index retrieval plans through legal RAG routes.",
