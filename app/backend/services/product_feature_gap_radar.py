    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ProductFeatureGap(
                ...
                current_state="Case primitives and a dashboard payload contract exist, but persistent workspace UI, parties/facts editing, and live risk-state updates are not complete.",
                ...
                next_actions=(
                    "Bind the case dashboard payload to the frontend case workspace.",
                    "Persist parties, facts, tasks, deadline flags, and evidence graph state.",
            ...
            ProductFeatureGap(
                ...
                current_state="Generated document storage, template governance evidence, export readiness, and delivery package manifest checks exist, but clause variables and renderer enforcement are incomplete.",
            ...
            ProductFeatureGap(
                ...
                module="billing",
                current_state="Entitlement checks, local quota policy, and privacy-safe quota persistence plan exist, but product packaging, invoice states, payment provider integration, and real persisted usage metering are incomplete.",
                ...
                next_actions=(
                    "Implement migrations and storage for the privacy-safe usage counter schema.",
            ...
            ProductFeatureGap(
                ...
                current_state="Knowledge, RAG audits, failure fixtures, source-freshness policy, and source ingestion metadata contracts exist, but durable source indexing and retrieval evaluation are incomplete.",
                ...
                next_actions=(
                    "Implement durable legal source indexing from the ingestion metadata contract.",
                    "Persist jurisdiction, effective-date, freshness, and dedupe metadata for retrieval sources.",
