    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ...
            ProductFeatureGap(
                ...
                title="Feedback loop",
                module="feedback",
                current_state="Feedback triage, roadmap alignment, lifecycle policy, and deterministic repeated issue clustering exist, but in-product capture and persistent closure tracking need implementation.",
            ...
            ProductFeatureGap(
                ...
                module="model_ops",
                current_state="Model routing, budgets, compatibility checks, Gemini/NewAPI cheap-first policy, task-level model selector audits, deterministic selector replay evidence, deep-review document quota blocking before AI drafting, a laptop-safe legal document benchmark suite, a LegalBench/LexGLUE/COLIEE research registry, and a maintenance UI for the metadata-only registry exist, but cost observability, result archives, and cheap-first guardrails still need product hardening.",
