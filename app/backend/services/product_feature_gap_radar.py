    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ...
            ProductFeatureGap(
                ...
                module="billing",
                current_state="Entitlement checks and local quota policy exist, but product packaging, invoice states, payment provider integration, and persisted usage metering are incomplete.",
                ...
                next_actions=(
                    "Persist privacy-safe usage counters for uploads, reviews, generated documents, and premium model escalation.",
            ...
            ProductFeatureGap(
                ...
                current_state="Knowledge, RAG audits, failure fixtures, and source-freshness policy exist, but source ingestion, durable freshness tracking, and retrieval evaluation are incomplete.",
                ...
                next_actions=(
                    ...
                    "Persist jurisdiction, effective-date, and freshness metadata for retrieval sources.",
