    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ProductFeatureGap(
                ...
                current_state="Case primitives, dashboard payload contract, notification policy, persistence plan, validated state repository, runtime binding facade, authenticated runtime routes, and typed frontend API helper exist, but frontend workspace editing and live risk-state updates are not complete.",
                ...
                next_actions=(
                    "Bind frontend editing actions to privacy-safe workbench state events.",
                    "Display runtime state and audit trail status in the case workbench.",
            ...
            ProductFeatureGap(
                ...
                module="billing",
                current_state="Entitlement checks, local quota policy, privacy-safe quota persistence and migration plans, quota counter repository, entitlement/quota binding facade, authenticated billing usage routes, and typed frontend API helper exist, but product packaging, invoice states, payment provider integration, deep-review consumption wiring, and workspace quota display are incomplete.",
                ...
                next_actions=(
                    ...
                    "Surface persisted quota snapshots and deterministic over-limit reasons in workspace UI.",
            ...
            ProductFeatureGap(
                ...
                current_state="Knowledge, RAG audits, failure fixtures, source-freshness policy, source ingestion metadata contracts, durable index plan, metadata-only index repository, indexed retrieval-plan binding, metadata-only legal RAG routes, and typed frontend API helper exist, but case UI integration is incomplete.",
                ...
                next_actions=(
                    "Bind case research UI to selected source ids, freshness warnings, and missing coverage reasons.",
