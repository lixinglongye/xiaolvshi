    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ...
            ProductFeatureGap(
                ...
                current_state="Generated document storage, generated_documents CRUD quota guard, case evidence-catalog/civil-complaint quota guard, evidence-catalog export preflight metadata, deep-review first-principles document-generation quota guard, selected-source binding, export-readiness metadata checks, metadata-only case download gates, quota delivery decisions, template governance evidence, delivery package manifest checks, version diff checklist, and a best-effort frontend report-quota consumption attempt after successful generation exist, but clause variables, final DOCX/PDF renderer enforcement, and delivery package release actions remain incomplete.",
                ...
                next_actions=(
                    ...
                    "Extend export-readiness gates from markdown downloads into final DOCX/PDF export actions.",
                    ...
                    "Bind delivery readiness results to final package release actions.",
                ),
            ),
            ProductFeatureGap(
                id="contract-review",
            ...
            ProductFeatureGap(
                ...
                module="evidence",
                current_state="Evidence services, a metadata-only evidence bundle integrity checker, evidence-catalog export preflight, and case download readiness gating exist, covering duplicates, missing sources, missing proof purposes, exhibit package policy, page anchors, three-factor review, and date/amount/checksum gaps; exhibit organization, chain-of-custody notes, final package release actions, and case linking still need a fuller workflow.",
                ...
                next_actions=(
                    "Extend evidence-catalog readiness from markdown download gating into final attachment package release.",
                    "Expose relevance and authenticity flags in backend payloads.",
                    "Add chain-of-custody notes and package version review to the evidence workflow.",
                ),
            ),
            ProductFeatureGap(
                id="ocr-import",
                ...
                current_state="Extraction quality checks, scanned/low-text OCR readiness policy, uploaded deep-review status binding, safe OCR failure-code persistence, and upload/progress UI OCR readiness panels exist, but structured import mapping, OCR retry execution records, and scanned-document fixtures need more coverage.",
                ...
                next_actions=(
                    "Persist OCR retry execution records and reviewer decisions across upload attempts.",
                    "Extend OCR readiness from deep-review polling into lawyer ZIP import and case material ingestion.",
            ...
            ProductFeatureGap(
                ...
                current_state="Authentication, entitlements, case team policy, role permission matrix evidence, and a first runtime cases API access-control gate now exist; durable matter memberships, approval workflow storage, sharing enforcement, and reviewer assignment remain incomplete.",
                ...
                next_actions=(
                    "Add durable case-scoped membership rows and approval workflow persistence behind the runtime gate.",
                    "Add reviewer assignment and access audit event persistence.",
            ...
            ProductFeatureGap(
                ...
                title="Feedback loop",
                module="feedback",
                current_state="Feedback triage, roadmap alignment, lifecycle policy, deterministic repeated issue clustering, a metadata-only adoption research bridge, reusable settings/report capture-plan previews, and admin feedback lifecycle summaries now exist, connecting feedback to user need IDs, product gap IDs, survey intake questions, release validation actions, support owners, and privacy-safe ticket defaults. Persistent closure-state storage still needs implementation.",
                ...
                next_actions=(
                    "Bind lifecycle policy to persisted feedback ticket status transitions and customer-visible closure fields.",
                    "Persist repeated issue clusters without storing raw legal matter text.",
                    "Wire adoption-bridge survey questions into the reusable feedback capture panel.",
            ...
            ProductFeatureGap(
                ...
                next_actions=(
                    "Wire the Legal RAG export readiness packet into live deep-review persistence and export actions.",
