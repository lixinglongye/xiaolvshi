    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ...
            ProductFeatureGap(
                ...
                module="maintenance",
                current_state="The 100+ update ledger, heartbeat evidence export, continuous session evidence validator, and metadata-only continuous session timeline exist, including max-gap, credential-scan, low-resource legal fixture, blocker, privacy-boundary, and 100+ update-count checks. The reviewer-facing product still lacks persisted real session records and a fully interactive timeline that joins commits, tests, pushes, low-resource benchmark events, release reviews, and support-claim readiness.",
