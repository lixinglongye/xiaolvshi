    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ...
            ProductFeatureGap(
                ...
                module="model_ops",
                current_state="Model routing, budgets, compatibility checks, Gemini/NewAPI cheap-first policy, task-level model selector audits, deterministic selector replay evidence, metadata-only cheap-first calibration in AIHub and ModelOps, deep-review document quota blocking before AI drafting, a laptop-safe legal document benchmark suite, a LegalBench/LexGLUE/COLIEE research registry, a maintenance UI for the metadata-only registry, and a public adoption/research bridge UI evidence exist, but cost observability, result archives, and cheap-first guardrails still need product hardening.",
