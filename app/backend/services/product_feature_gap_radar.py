    ...
    def _feature_gaps(self) -> tuple[ProductFeatureGap, ...]:
        return (
            ...
            ProductFeatureGap(
                ...
                next_actions=(
                    "Bind lifecycle policy to persisted feedback ticket status transitions.",
                    "Persist repeated issue clusters without storing raw legal matter text.",
                    "Wire adoption-bridge survey questions deeper into report-level feedback capture.",
