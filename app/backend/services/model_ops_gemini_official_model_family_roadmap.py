...
OFFICIAL_FAMILY_TARGETS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "premium_exception_model": "gemini-3.1-pro-preview",
    ...
    },
    {
        ...
        "preferred_cheap_first_model": "gemini-3.1-flash-live-preview",
        ...
        "default_claim": "cataloged_review_required_without_route_support",
    },
    {
        "family_id": "veo-video",
        "display_name": "Veo video generation",
        "official_scope": "Veo video generation models exposed through Gemini API media routes.",
        ...
        "preferred_cheap_first_model": "veo-3.1-lite-generate-preview",
        "fallback_model": "veo-3.1-fast-generate-preview",
        "premium_exception_model": "veo-3.1-generate-preview",
        "route_policy": "explicit_video_route_review_only",
        "default_claim": "cataloged_review_required_without_default_change",
    },
    {
    ...
    },
    {
        ...
        "preferred_cheap_first_model": "gemini-2.5-flash-preview-tts",
        "fallback_model": "gemini-3.1-flash-tts-preview",
        "premium_exception_model": "gemini-2.5-pro-preview-tts",
