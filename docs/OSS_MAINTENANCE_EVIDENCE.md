...
- Model operations: model catalog, budget policy, task inference, runtime routing, route telemetry, route guardrails, callsite audit, fallback chains, routing replay, usage-safe telemetry.
