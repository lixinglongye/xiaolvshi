...
- Quality control: deep-review quality gates, legal-review benchmark cases, cheap-first legal fixture prompt packs, safe gateway request manifests, lightweight synthetic legal document fixtures, and fixture-driven prompt/schema improvement planning.
