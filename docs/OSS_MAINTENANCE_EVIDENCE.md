...
- Quality control: deep-review quality gates, legal-review benchmark cases, fixture-level Gemini/NewAPI model matrices, cheap-first legal fixture prompt packs, safe gateway request manifests, laptop-safe fixture run plans, cheap-first fixture run reports, lightweight synthetic legal document fixtures, and fixture-driven prompt/schema improvement planning.
