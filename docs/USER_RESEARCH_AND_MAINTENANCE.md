...
- Legal research backlogs: `/api/v1/maintenance/legal-review-benchmark/research-backlog` maps LegalBench, FrugalGPT, RAGAS, CRAG, CUAD, LegalBench-RAG, LexEval, and CaseGen signals into concrete algorithm, model-routing, benchmark, grounding, Chinese legal-document, and UI review tasks.
- Public benchmark samplers: `/api/v1/maintenance/legal-review-benchmark/public-sampler` maps reviewed LegalBench, CUAD, LexGLUE, LegalBench-RAG, LexEval, CaseGen, and Pile of Law samples back to small local fixtures with no default dataset download.
