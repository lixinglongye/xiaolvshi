...
- Legal review benchmark coverage, including cheap-first fixture prompt packs, safe gateway request manifests, laptop-safe fixture run plans, lightweight synthetic document fixtures, and fixture-driven improvement plans.
